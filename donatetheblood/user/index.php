...
<?php 
	...
	if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])){
		...
		if(isset($_POST['userId'])){
			...
			$sql = "UPDATE donor1 SET save_life_date = '$crntDate' WHERE id='$userId'";
						...
						<div class="panel-body">
							...
							<?php  
								...
								if($safeDate == '0'){
									...
									$start = date_create("$safeDate");//database save_life_date
									$end = date_create();
									...
									<span>You already Safe the life. You can donate the blood after three months. We are very thankfull to you.</span>
									</div>	';
